...
export function getNextMove(currentMove, playersCount, playersTimesOver) {
  const slicedMoveOrder = MOVE_ORDER.slice(0, playersCount).filter(symbol => !playersTimesOver.includes(symbol));
